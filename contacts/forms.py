    ...
    class Meta:
        ...
        widgets = {
            ...
            "phone": forms.TextInput(
                attrs={"placeholder": "+33 1 23 45 67 89", "label": "Téléphone"}
            ),
            "email": forms.EmailInput(
                attrs={"placeholder": "contact@example.com", "label": "Email"}
            ),
            "website": forms.URLInput(
                attrs={"placeholder": "https://www.example.com", "label": "Site web"}
            ),
        }
