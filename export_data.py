        ...
        for obj in queryset:
            ...
            for field in obj._meta.many_to_many:
                ...
                if field.name == 'artists':
                    ...
                    obj_dict[field.name] = [collection.name for collection in related_objects]
                elif field.name == 'exhibitions':
                    obj_dict[field.name] = [exhibition.name for exhibition in related_objects]
                else:
                    obj_dict[field.name] = [str(related_obj) for related_obj in related_objects]
