...
class ArtworkAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'title', 'get_artists_display', 'art_type', 'creation_year', 
        'current_location', 'user', 'is_acquired'
    ]
    list_filter = [
        'art_type', 'support', 'technique', 'current_location', 
        'is_signed', 'is_framed', 'is_acquired', 'user', 'created_at'
    ]
    search_fields = [
        'title', 'artists__name', 'notes', 'contextual_references',
    ...
    fieldsets = (
        ...
        ('Status and Location', {
            'fields': (
                'current_location', 'is_signed', 'is_framed', 
                'is_borrowed', 'is_acquired', 'owners'
            ),
    ...
    def get_queryset(self, request):
        ...
        return super().get_queryset(request).select_related(
            'user', 'art_type', 'support', 'technique'
...
class WishlistItemAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'title', 'artist_name', 'priority', 'estimated_price', 
        'user', 'created_at'
    ]
    ...
    fieldsets = (
        ...
        ('Details', {
            'fields': ('estimated_price', 'priority', 'source_url')
        }),
        ('Notes', {
            'fields': ('notes',),
            'classes': ('wide',)
