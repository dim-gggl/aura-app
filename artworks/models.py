...
class Artwork(models.Model):
    ...
    # Foreign keys to reference models with SET_NULL to preserve data if reference is deleted
    ...
    is_acquired = models.BooleanField(default=True, verbose_name="Est acquise")  # False for wishlist items
...
class WishlistItem(models.Model):
    ...
    priority = models.IntegerField(default=3, choices=PRIORITY_CHOICES, verbose_name="Priorité")
