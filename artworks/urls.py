...
urlpatterns = [
    ...
    path(
        "artists/<int:pk>/export/html/",
        views.artist_export_html,
        name="artist_export_html",
    ),
    path(
        "artists/<int:pk>/export/pdf/",
        views.artist_export_pdf,
        name="artist_export_pdf",
    ),
    path(
        "collections/<int:pk>/export/html/",
        views.collection_export_html,
        name="collection_export_html",
    ),
    path(
        "collections/<int:pk>/export/pdf/",
        views.collection_export_pdf,
        name="collection_export_pdf",
    ),
    path(
        "exhibitions/<int:pk>/export/html/",
        views.exhibition_export_html,
        name="exhibition_export_html",
    ),
    path(
        "exhibitions/<int:pk>/export/pdf/",
        views.exhibition_export_pdf,
        name="exhibition_export_pdf",
    ),
    # Special features
    ...
    path(
        "collections/<int:pk>/edit/", views.collection_update, name="collection_update"
    ),
    path(
    ...
    path(
        "exhibitions/<int:pk>/edit/", views.exhibition_update, name="exhibition_update"
    ),
    path(
        "exhibitions/<int:pk>/delete/",
        views.exhibition_delete,
    ...
    path(
        "techniques/<int:pk>/delete/", views.technique_delete, name="technique_delete"
    ),
    # ========================================
    # AJAX ENDPOINTS
    # ========================================
    ...
    path(
        "ajax/collection/create/",
        views.collection_create_ajax,
        name="collection_create_ajax",
    ),
    path(
        "ajax/exhibition/create/",
        views.exhibition_create_ajax,
        name="exhibition_create_ajax",
    ),
    ...
    path(
        "ajax/technique/create/",
        views.technique_create_ajax,
        name="technique_create_ajax",
    ),
    # Tags autocomplete
