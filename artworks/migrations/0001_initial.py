    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Type d'art"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Support"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Technique"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "death_year",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Année de décès"
                    ),
                ),
                (
                    "nationality",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(blank=True, max_length=300, verbose_name="Titre"),
                ),
                (
                    "creation_year",
                    models.IntegerField(
                ...
                (
                    "acquisition_place",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Lieu d'acquisition"
                    ),
                ),
                (
                    "price",
                ...
                (
                    "is_framed",
                    models.BooleanField(default=False, verbose_name="Est encadrée"),
                ),
                (
                    "is_borrowed",
                    models.BooleanField(default=False, verbose_name="Est empruntée"),
                ),
                (
                    "is_signed",
                    models.BooleanField(default=False, verbose_name="Est signée"),
                ),
                (
                    "is_acquired",
                    models.BooleanField(default=True, verbose_name="Est acquise"),
                ),
                (
                    "current_location",
                    models.CharField(
                ...
                (
                    "owners",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="Propriétaire(s)"
                    ),
                ),
                (
                ...
                (
                    "last_exhibited",
                    models.DateField(
                        blank=True, null=True, verbose_name="Dernière exposition"
                    ),
                ),
                (
                    "art_type",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="artworks.artist", verbose_name="Artiste(s)"
                    ),
                ),
                (
                    "parent_artwork",
            ...
            fields=[
                ...
                (
                    ...
                    imagekit.models.fields.ProcessedImageField(
                        blank=True, null=True, upload_to="artworks/"
                    ),
                ),
                (
                    "caption",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="artworks.collection", verbose_name="Collection(s)"
            ),
        ),
        migrations.CreateModel(
            name="Exhibition",
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=200, verbose_name="Nom de l'exposition"
                    ),
                ),
                (
                    "location",
        ...
        migrations.AddField(
            ...
            name="exhibitions",
            field=models.ManyToManyField(
                blank=True, to="artworks.exhibition", verbose_name="Exposition(s)"
            ),
        ),
        migrations.AddField(
            model_name="artwork",
        ...
        migrations.AddField(
            ...
            field=taggit.managers.TaggableManager(
                ...
                through="artworks.UUIDTaggedItem",
                to="taggit.Tag",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        default="Général", max_length=300, verbose_name="Titre"
                    ),
                ),
                (
                    "artist_name",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Artiste"
                    ),
                ),
                (
                    "estimated_price",
